    ...
    markets: [
      {
        ...
        selections: [
          ...
          { key: "draw", label: "Empate", sharpOdds: 3.61, bestOdds: 3.70, bestBookmaker: "Codere" },
          { key: "away", label: "Villarreal", sharpOdds: 2.96, bestOdds: 3.05, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "totals",
        ...
        line: 2.5,
        selections: [
          { key: "over", label: "Más de 2.5", sharpOdds: 1.89, bestOdds: 1.95, bestBookmaker: "Betfair" },
          { key: "under", label: "Menos de 2.5", sharpOdds: 2.04, bestOdds: 2.10, bestBookmaker: "Codere" },
        ],
      },
      {
        kind: "btts",
        ...
        selections: [
          ...
          { key: "no", label: "No", sharpOdds: 2.16, bestOdds: 2.25, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "ah",
        ...
        line: -0.5,
        selections: [
          { key: "home", label: "Real Sociedad −0.5", sharpOdds: 2.45, bestOdds: 2.60, bestBookmaker: "Winamax" },
    ...
    markets: [
      {
        ...
        label: "1X2",
        selections: [
          { key: "home", label: "Atlético de Madrid", sharpOdds: 1.43, bestOdds: 1.47, bestBookmaker: "Codere" },
          { key: "draw", label: "Empate", sharpOdds: 4.88, bestOdds: 5.20, bestBookmaker: "Bet365" },
          { key: "away", label: "Elche", sharpOdds: 8.13, bestOdds: 8.60, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "totals",
        ...
        selections: [
          ...
          { key: "under", label: "Menos de 2.5", sharpOdds: 2.33, bestOdds: 2.45, bestBookmaker: "Codere" },
        ],
      },
      {
        kind: "btts",
        label: "Ambos marcan",
        selections: [
          { key: "yes", label: "Sí", sharpOdds: 2.02, bestOdds: 2.10, bestBookmaker: "Winamax" },
      ...
      },
      {
        ...
        selections: [
          ...
          { key: "away", label: "Elche +1.5", sharpOdds: 1.75, bestOdds: 1.80, bestBookmaker: "Codere" },
        ],
      },
    ],
  },
    ...
    markets: [
      {
        ...
        selections: [
          ...
          { key: "draw", label: "Empate", sharpOdds: 3.48, bestOdds: 3.60, bestBookmaker: "Winamax" },
          { key: "away", label: "Athletic Club", sharpOdds: 3.25, bestOdds: 3.45, bestBookmaker: "Codere" },
        ],
      },
      {
        kind: "totals",
        ...
        selections: [
          ...
          { key: "under", label: "Menos de 2.5", sharpOdds: 1.96, bestOdds: 2.08, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "btts",
        label: "Ambos marcan",
        selections: [
          { key: "yes", label: "Sí", sharpOdds: 1.83, bestOdds: 1.88, bestBookmaker: "Codere" },
      ...
      },
      {
        ...
        line: -0.5,
        selections: [
          { key: "home", label: "Real Betis −0.5", sharpOdds: 2.33, bestOdds: 2.40, bestBookmaker: "Winamax" },
    ...
    markets: [
      {
        ...
        label: "1X2",
        selections: [
          { key: "home", label: "Barcelona", sharpOdds: 1.22, bestOdds: 1.25, bestBookmaker: "Codere" },
          { key: "draw", label: "Empate", sharpOdds: 7.5, bestOdds: 8.0, bestBookmaker: "Bet365" },
          { key: "away", label: "Levante", sharpOdds: 13.94, bestOdds: 15.0, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "totals",
        ...
        selections: [
          ...
          { key: "under", label: "Menos de 3.5", sharpOdds: 2.22, bestOdds: 2.35, bestBookmaker: "Codere" },
        ],
      },
      {
        kind: "btts",
        label: "Ambos marcan",
        selections: [
          { key: "yes", label: "Sí", sharpOdds: 2.32, bestOdds: 2.45, bestBookmaker: "Codere" },
      ...
      },
      {
        ...
        line: -2.5,
        selections: [
          { key: "home", label: "Barcelona −2.5", sharpOdds: 2.12, bestOdds: 2.25, bestBookmaker: "Winamax" },
    ...
    markets: [
      {
        ...
        selections: [
          ...
          { key: "draw", label: "Empate", sharpOdds: 3.61, bestOdds: 3.75, bestBookmaker: "Codere" },
          { key: "away", label: "Girona", sharpOdds: 3.36, bestOdds: 3.55, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "totals",
        ...
        line: 2.5,
        selections: [
          { key: "over", label: "Más de 2.5", sharpOdds: 1.91, bestOdds: 1.98, bestBookmaker: "Codere" },
      ...
      },
      {
        ...
        selections: [
          ...
          { key: "no", label: "No", sharpOdds: 2.11, bestOdds: 2.15, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "ah",
        ...
        line: -0.5,
        selections: [
          { key: "home", label: "Rayo −0.5", sharpOdds: 2.22, bestOdds: 2.3, bestBookmaker: "Codere" },
    ...
    markets: [
      {
        ...
        selections: [
          ...
          { key: "draw", label: "Empate", sharpOdds: 6.1, bestOdds: 6.5, bestBookmaker: "Codere" },
          { key: "away", label: "Osasuna", sharpOdds: 12.2, bestOdds: 13.0, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "totals",
        ...
        selections: [
          ...
          { key: "under", label: "Menos de 2.5", sharpOdds: 2.57, bestOdds: 2.72, bestBookmaker: "Winamax" },
        ],
      },
      {
        kind: "btts",
        label: "Ambos marcan",
        selections: [
          { key: "yes", label: "Sí", sharpOdds: 2.22, bestOdds: 2.32, bestBookmaker: "Codere" },
      ...
      },
      {
        ...
        line: -1.5,
        selections: [
          { key: "home", label: "Real Madrid −1.5", sharpOdds: 1.88, bestOdds: 1.95, bestBookmaker: "Winamax" },
          { key: "away", label: "Osasuna +1.5", sharpOdds: 2.03, bestOdds: 2.12, bestBookmaker: "Codere" },
        ],
      },
    ],
  },
